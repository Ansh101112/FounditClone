          ...
          <Accordion defaultIndex={[0]} allowMultiple >
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign={"start"} fontSize="xs">
                <List>
                  <ListItem color-green>HR</ListItem>
                  <ListItem color-green>Sales</ListItem>
                  <ListItem color-green>Accounting</ListItem>
                  <ListItem color-green>Call Center</ListItem>
                  <ListItem color-green>Event Management</ListItem>
                </List>
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign={"start"} fontSize="xs">
                <List>
                  <ListItem color-green>Software Engineer</ListItem>
                  <ListItem color-green>Full Stack Developer</ListItem>
                  <ListItem color-green>SQL</ListItem>
                  <ListItem color-green>Oracle</ListItem>
                  <ListItem color-green>Digital Marketing</ListItem>
                </List>
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign={"start"} fontSize="xs">
                <List>
                  <ListItem color-green>Job Seekers Login</ListItem>
                  <ListItem color-green>Resume Upload</ListItem>
                  <ListItem color-green>Search Tip</ListItem>
                  <ListItem color-green>Job Alerts</ListItem>
                  <ListItem color-green>Help</ListItem>
                </List>
              </AccordionPanel>
            </AccordionItem>
